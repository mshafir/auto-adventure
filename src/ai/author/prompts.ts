...
export function adjustPrompt(input: {
	...
	return [
		...
		"             only once those are done, and it is opened by somebody listed above.",
		"             Its objective may be reaching any settlement listed above, or speaking to",
		"             somebody who is standing in the *same* settlement as the beat itself — a",
		"             person two towns away is not somebody the player can be told to go and",
		"             talk to here.",
		"",
