...
import { cellPixels, renderTilePixels, resolveTileMode, type TileMode } from "./render/mode.js";
...
function KittyViewport({
	...
	const rows = useMemo(() => {
		...
		//
		// Capped by how many tiles there are, though, because the frame's size is
		// otherwise decided entirely by the window: at 163x70 cells it came to eight
